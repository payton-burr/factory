...
> In the `@factory/agents` package, this plugin's directory (`${CLAUDE_PLUGIN_ROOT}`) is `../..` relative to this skill's directory. Use its absolute path wherever this file refers to the plugin directory.
